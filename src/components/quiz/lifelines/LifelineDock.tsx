...
export default function LifelineDock({
  ...
  return (
    ...
    >
      ...
      <div className="w-full min-w-0 rounded-xl border border-border/35 bg-background/70 px-2.5 py-2 shadow-sm backdrop-blur-sm">
        <div className="flex w-full min-w-0 flex-col items-center gap-2 sm:flex-row sm:items-center sm:gap-2.5">
          {label ? (
            <div className="flex shrink-0 items-center justify-center gap-1.5 sm:justify-start">
              <span className="whitespace-nowrap text-[9px] font-body font-semibold uppercase tracking-[0.16em] text-muted-foreground/90 sm:text-[10px] sm:tracking-widest">
                {label}
              </span>
              <Popover>
          ...
          <div className="hidden h-6 w-px shrink-0 bg-border/40 sm:block" aria-hidden />

          <p className="text-[10px] font-body font-medium text-muted-foreground/80 sm:hidden">
            Tap an icon to use a lifeline (single-use).
          </p>

          <div className="flex min-w-0 flex-1 flex-wrap items-center justify-center gap-1.5 sm:justify-start sm:gap-1.5">
